...
<body class="login"
    style="background-image:url({{ asset('public/img/bg1.jpg') }});background-repeat:no-repeat;background-position-x: center;background-attachment: fixed;  background-size: 1000px 500px;">
    @yield('container')
</body>
